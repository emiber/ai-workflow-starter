...
1. Read `workflow/rules.md`, `workflow/principles.md`, `workflow/issue-creation.md`, and `workflow/issue-tracker.md`.
...
6. Confirm with the issue number/key and URL, and suggest running the refine-issue skill to make it implementable.
