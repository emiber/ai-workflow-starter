---
name: review-pr
description: Reviews an open PR against its linked issue(s) and the Definition of Done. Read-only. Reads workflow/pr-review.md.
---

# /review-pr

You review the open PR $ARGUMENTS against its linked issue(s) and the Definition of Done, following the contract in `workflow/pr-review.md`. This command is **read-only**: never commit, push, or modify files.
